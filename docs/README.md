...
Stage-specific rules live only in `../specs/`. Do not duplicate Stage inputs, schemas, enums, review policies, or exit criteria under `docs/`.
...
- `storage-model.md` — workspace object families and storage roles.
